...
PROJECT_DEMOS_FOLDER_ENV: Optional[str] = os.getenv(
    "COOKIECUTTER_ROBUST_PYTHON_PROJECT_DEMOS_FOLDER", DEFAULT_PROJECT_DEMOS_FOLDER
)
PROJECT_DEMOS_FOLDER: Path = Path(PROJECT_DEMOS_FOLDER_ENV).resolve()
